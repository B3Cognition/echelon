...
- **EGR-116 / #142 prompt tool contract scanner** — harness-internal
  discovery detection now flags `view/show/display src/harness/...` phrasing
  in addition to read/open/review/inspect style prompts.
- **EGR-117 / #141 delivery runtime surface** — direct and workspace-target
  ...
  manifest/packaging metadata from target-visible worktrees.
