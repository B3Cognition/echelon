...
- **EGR-125 / #149 build-slice context** — Ralph now writes a Python-owned
  ...
  hints, package-manager lockfile hints, Python package-manager hints, Python
  project script hints, target layout excerpts with representative source/test
  files, and build rules, and the prompt tells agents to read it before
  implementation.
