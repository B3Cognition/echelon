...
- **EGR-119 / #143 verify-spec state ownership** — verify-spec phase commands
  ...
  supplied. Stage 5 judgment/report commands also require that state before
  writing prepass, fallback, or assembled fulfillment artifacts, and fulfillment
  artifact row-set validation checks state before importing or validating
  report inputs.
