...
- `.echelon/runtime/templates/test-strategy-template.md` for `test-strategy.md`
- `.echelon/runtime/templates/test-architecture-template.md` for `test-architecture.md`
- `.echelon/runtime/templates/coverage-map-template.md` for `coverage-map.md`
...
Use `.echelon/runtime/templates/test-strategy-template.md`.

### test-architecture.md

Use `.echelon/runtime/templates/test-architecture-template.md`.
