...
- `.echelon/runtime/templates/contradictions-and-gaps-template.md` -> `contradictions-and-gaps.md`
- `.echelon/runtime/templates/risks-template.md` -> `risks.md`
- `.echelon/runtime/templates/people-and-teams-template.md` -> `people-and-teams.md` (if discoverable)
- `.echelon/runtime/templates/timeline-template.md` -> `timeline.md` (if discoverable)
- `.echelon/runtime/templates/qa-test-strategy-inputs-template.md` -> `qa-test-strategy-inputs.md` (if discoverable)
...
Use `.echelon/runtime/templates/mental-model-template.md`. Merge entities and relationships, include cardinality, preserve sources, and flag source gaps.

### boundaries.md (unified)
Use `.echelon/runtime/templates/boundaries-template.md`. Merge boundaries, include communication and trust signals, and flag contradictions.

### assumptions.md (unified)
Use `.echelon/runtime/templates/assumptions-template.md`. Deduplicate assumptions, preserve source and confidence, and flag contradictory assumptions.
...
Use `.echelon/runtime/templates/risks-template.md`. Include risks identified from cross-referencing, including knowledge concentration, stale dependencies, documentation drift, and architecture assumptions that contradict code reality.

### people-and-teams.md (if discoverable)
Use `.echelon/runtime/templates/people-and-teams-template.md`. Include ownership, active contributors, and knowledge concentration risks.

### timeline.md (if discoverable)
Use `.echelon/runtime/templates/timeline-template.md`. Include development history, velocity trends, and stale modules.

### qa-test-strategy-inputs.md (if discoverable)
Use `.echelon/runtime/templates/qa-test-strategy-inputs-template.md`. Include current test state, coverage, frameworks, and gaps.
