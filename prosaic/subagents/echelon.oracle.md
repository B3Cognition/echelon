...
- `.echelon/runtime/templates/domain-patterns-template.md` for `domain-patterns.md`
- `.echelon/runtime/templates/domain-amendments-template.md` for domain amendments to `spec.md`, `plan.md`, and `glossary.md`
- `.echelon/runtime/templates/compliance-gaps-template.md` for `COMPLIANCE_GAP` items
- `.echelon/runtime/templates/terminology-corrections-template.md` for glossary terminology corrections
...
- **`domain-patterns.md`** — use `.echelon/runtime/templates/domain-patterns-template.md`
