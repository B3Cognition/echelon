...
If `{{args}}` is provided, use it to focus the reality check on a specific area (e.g., "cost estimates", "performance claims", "timeline feasibility").
  ...
  journal_entries:
    - type: decision
      ...
      data:
        ...
        rationale: "Dispatch REALIST for focus: {{{args}} or 'full sweep'}."
        content: "GROUND dispatched manually. Focus: {{{args}} or 'full sweep'}. Check reality-check.md for findings."
```
