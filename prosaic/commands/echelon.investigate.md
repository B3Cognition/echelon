...
If `{{args}}` is empty or missing, report **"Please provide a question to investigate. Usage: echelon.investigate <your question>"** and stop.
...
Also read:
- `.echelon/runtime/templates/evidence-grades.md` -- grading reference
- `.echelon/runtime/templates/experiment-results-template.md` -- required format if an experiment runs
