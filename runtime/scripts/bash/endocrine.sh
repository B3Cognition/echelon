...
agent_to_archetype() {
  ...
  case "$agent" in
    ...
    GATEKEEPER)
      echo "feasibility" ;;
    ARCHITECT|ORCHESTRATOR|SENTINEL|ORACLE|BENCHMARK|RE_PLANNER|RE_TASKER|RE_BASELINER|RE_DEEPENER|RE_RESOLVER)
      echo "solution" ;;
...
ALL_AGENTS=(
  ...
  RE_CHECKLISTER RE_VALIDATOR RE_VERIFIER RE_BASELINER RE_DEEPENER RE_RESOLVER
  SUMMARIZER
)
