...
- Governance artifact: `.echelon/constitution.md` (read-only)
...
- `.echelon/constitution.md` (read-only governance)
...
- **prompt:**
  ...
  ```xml
  <context>
  [include spec.md, read-only .echelon/constitution.md, plan.md, research.md, data-model.md, contracts/, tasks.md, critical-path.md, risk-matrix.md, dependencies.md, test-strategy.md, coverage-map.md, sage WHY3 output templates, calibration-profile.yaml, reasoning-journal.jsonl]
  </context>
...
- **prompt:**
  ...
  ```xml
  <context>
  [include spec.md, read-only .echelon/constitution.md, plan.md, research.md, data-model.md, contracts/, tasks.md, critical-path.md, risk-matrix.md, dependencies.md, test-strategy.md, coverage-map.md, quality-gates.md, issues.md, implementability-report.md from ASSESS2, reasoning-journal.jsonl]
  </context>
