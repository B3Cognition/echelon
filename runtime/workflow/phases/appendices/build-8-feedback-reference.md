...
7. If `constitution_amendments_pending > 0`: add to the final run summary: `{N} constitution amendment candidate(s) pending human review - see {spec_dir}/constitution-amendment-candidates.md. Route an approved amendment to CHIEF.`
