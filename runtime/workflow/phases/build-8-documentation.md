...
6. Treat `.echelon/runnability.yml` as the candidate contract and the current
   ...
   passed and for separately declared local commands that remain unverified.
