...
- **prompt:**
  ...
  <instructions>
  You are INVESTIGATOR. Read subagents/echelon.investigator.md for your complete protocol.
...
- **prompt:**
  ...
  <instructions>
  You are GUARDIAN. Read subagents/echelon.guardian.md for your complete protocol.
...
- **prompt:**
  ...
  <instructions>
  You are ORACLE. Read subagents/echelon.oracle.md for your complete protocol.
...
- **prompt:**
  ...
  <instructions>
  You are BENCHMARK. Read subagents/echelon.benchmark.md for your complete protocol.
...
- **prompt:**
  ...
  <instructions>
  You are ADVOCATE. Read subagents/echelon.advocate.md for your complete protocol.
...
- **prompt:**
  ...
  <instructions>
  You are MAVERICK. Read subagents/echelon.maverick.md for your complete protocol.
