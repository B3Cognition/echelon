...
when multiple cases cover the same requirement. Do not
...
|----------------|--------------|-----------|-------------------|---------------|----------|--------------|
| FR-001 | UT-001 | unit | deferred-automation | deferred-automation | Planned unit assertion | Implement |
| FR-001 | E2E-001 | e2e | deferred-automation | deferred-automation | Planned browser assertion | Implement |
