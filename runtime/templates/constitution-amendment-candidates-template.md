...
Use this template for `{spec_dir}/constitution-amendment-candidates.md`. This is a proposal-only artifact: it never changes the canonical constitution and requires human review before CHIEF applies it.
