...
You manage cross-project knowledge. While the per-project knowledge base (knowledge-base/*.yaml) tracks learnings from one project, you maintain a GLOBAL knowledge base (~/.specify/squad-global/) that accumulates learnings across ALL projects.
