# Echelon v0.2: Structure & Naming — Implementation Plan

> **For agentic workers:** REQUIRED: Use superpowers:subagent-driven-development (if subagents available) or superpowers:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Reorganize echelon with layer-based directory structure, dual naming (functional + codename), 4-phase architecture, and autonomy modes.

**Architecture:** Rename all agent files to use codenames as filenames while preserving functional names in prompts. Restructure into layers: control, exploration, feasibility, solution, specialists, learning, build. Update COMMANDER (echelon.run.md) with phase-based execution and `--mode` flag.

**Tech Stack:** Markdown (agent prompts), YAML (config), JSON (state schema), Bash (file operations)

**Design Doc:** [2026-03-18-echelon-evolution-design.md](../specs/2026-03-18-echelon-evolution-design.md)
...
### Task 17: Update echelon.run.md with 4-phase model
...
Replace ALL agent path references in echelon.run.md using these exact substitutions:
...
- [ ] **Step 5: Commit echelon.run.md update**
...
**Files:**
- Modify: `commands/echelon.investigate.md`
- Modify: `commands/echelon.ground.md`
- Modify: `commands/echelon.innovate.md`
- Modify: `commands/echelon.build.md`
- Modify: `commands/echelon.status.md`
- Modify: `commands/echelon.resume.md`
- Modify: `commands/echelon.feedback.md`
- Modify: `commands/echelon.change.md`
- Modify: `commands/echelon.verify.md`
...
```bash
/speckit.echelon.run "Build an app"                  # semi (default)
/speckit.echelon.run "Build an app" --mode guided    # checkpoint after each phase
/speckit.echelon.run "Build an app" --mode banzai    # full autonomous
```
...
3. 4-phase execution model in echelon.run.md
