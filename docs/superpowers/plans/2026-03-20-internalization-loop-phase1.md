...
In `commands/echelon.run.md`, find the preflight section (around line 259-291 where `preflight-speckit.sh` is called). Add after the spec-kit dependency check:
