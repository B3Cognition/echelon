...
- [x] **Step 1: Write failing snapshot and comparison tests**
...
- [x] **Step 3: Integrate observation at the outer verification boundary**
...
- [x] **Step 4: Add deterministic stall finalization and high-water prompt context**
...
- [x] **Step 5: Run controller and resume tests and verify GREEN**
...
- [x] **Step 3: Implement defaults and presentation**
...
```bash
git add src/harness/run_intent.py src/harness/state.py src/echelon/cli.py src/harness/skills/run_skill.py src/harness/ralph.py tests/unit/test_run_intent.py tests/unit/test_cli_delivery_status.py tests/unit/test_run_skill.py tests/unit/test_ralph_outer.py
...
- [x] **Step 1: Run focused loop regression suites**
...
- [x] **Step 2: Fix regressions test-first**
