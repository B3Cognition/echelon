...
class TestRunContinuity:
    ...
    def test_run_md_reads_run_history_at_init_to_skip_phase_a(self) -> None:
        ...
        content = (RUNTIME / "workflow/phases/init.md").read_text()
    ...
    def test_run_md_writes_run_history_at_done(self) -> None:
        ...
        init = (RUNTIME / "workflow/phases/init.md").read_text()
        finalize = (RUNTIME / "workflow/phases/phase4-document.md").read_text()
