...
SUBAGENT_POLICY = {
    ...
    "echelon.delivery-implementer.md": ("strong", "high"),
    ...
    "echelon.re-discoverer.md": ("strong", "high"),
    "echelon.re-discovery-reviewer.md": ("strong", "high"),
    "echelon.re-exhaustive-analyst.md": ("strong", "high"),
    "echelon.re-exhaustive-verifier.md": ("strong", "high"),
    "echelon.re-checklister.md": ("fast", "low"),
    "echelon.re-constituter.md": ("strong", "high"),
    "echelon.re-expander.md": ("strong", "high"),
    "echelon.re-knowledge-reconciler.md": ("strong", "high"),
    "echelon.re-planner.md": ("strong", "high"),
    "echelon.re-resolver.md": ("strong", "high"),
    "echelon.re-specifier.md": ("strong", "high"),
    "echelon.re-synthesizer.md": ("strong", "high"),
    ...
    "echelon.review-debugger.md": ("strong", "medium"),
    "echelon.review-sentinel.md": ("strong", "medium"),
    "echelon.review-spec-guard.md": ("strong", "medium"),
