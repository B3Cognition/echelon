...
AGENT = ROOT / "prosaic" / "subagents" / "echelon.modeler.md"
PHASE = ROOT / "runtime" / "workflow" / "phases" / "phase1-modeler.md"
...
class TestModelerTemplates:
    ...
    def test_modeler_prompt_references_template_and_canonical_output(self) -> None:
        ...
        assert ".echelon/runtime/templates/mental-model-code-template.md" in text
