...
Task 5 fix round 1: the journal fixture ruling was accepted and corrected in scope; schema-v1 certificates now reject missing/default or explicit proportional mode and remain available only through the perfectionist path. Final code head e8a5b09b: focused 1139, expanded 1729, run-all 1649/0, deployment 146, bundles 9/9, full pytest 8885 plus exactly 3 baseline failures. Tasks Lexicon defects remain deferred unchanged.
