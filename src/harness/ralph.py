...
_TOOL_ACCESS_LINE_RE = re.compile(
    r"(?:"
    r"▷\s*(?:Read|NotebookRead|Write|Edit|MultiEdit|Bash|Grep|Glob|Find|Search|List|LS|Open)|"
    r"\b(?:Read|NotebookRead|Write|Edit|MultiEdit|Bash|Grep|Glob|Find|Search|List|LS|Open):|"
