...
**Output:** Updated echelon-veteran (VETERAN) schemas, echelon-veteran (VETERAN) notification entries, and `{spec_dir}/patterns/schema-consolidation.md` using `extension/templates/schema-consolidation-template.md`.
