...
agent_to_archetype() {
  ...
  case "$agent" in
    ...
    ARCHITECT|ORCHESTRATOR|SENTINEL|ORACLE|BENCHMARK|PLANNER|TASKER)
      echo "solution" ;;
    IMPLEMENTER|SPEC_GUARD|CODE_REVIEWER|TEST_GUARDIAN|DEBUGGER|INTEGRATOR|CHANGE_CONTROLLER|VISUAL_VALIDATOR|VERIFICATION|ENGINEERING_MANAGER|IMPLEMENTATION_MAPPER|SPEC_FULFILLMENT_AUDITOR)
      echo "build" ;;
...
ALL_AGENTS=(
  ...
  CHIEF IMPLEMENTATION_MAPPER SPEC_FULFILLMENT_AUDITOR
