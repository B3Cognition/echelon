...
THRESHOLD_FILES="${ECHELON_CFG_RE_CHUNKING_THRESHOLD_FILES:-${REVENGE_CFG_CHUNKING_THRESHOLD_FILES:-${SPECKIT_REVERSE_ENG_CHUNKING_THRESHOLD_FILES:-500}}}"
THRESHOLD_LINES="${ECHELON_CFG_RE_CHUNKING_THRESHOLD_LINES:-${REVENGE_CFG_CHUNKING_THRESHOLD_LINES:-${SPECKIT_REVERSE_ENG_CHUNKING_THRESHOLD_LINES:-100000}}}"
MAX_CHUNK_FILES="${ECHELON_CFG_RE_CHUNKING_MAX_FILES:-${REVENGE_CFG_CHUNKING_MAX_FILES:-${SPECKIT_REVERSE_ENG_CHUNKING_MAX_FILES:-50}}}"
MAX_CHUNK_LINES="${ECHELON_CFG_RE_CHUNKING_MAX_LINES:-${REVENGE_CFG_CHUNKING_MAX_LINES:-${SPECKIT_REVERSE_ENG_CHUNKING_MAX_LINES:-15000}}}"
CHUNKING_MODE="${ECHELON_CFG_RE_CHUNKING_MODE:-${REVENGE_CFG_CHUNKING_MODE:-${SPECKIT_REVERSE_ENG_CHUNKING_MODE:-auto}}}"
STRATEGY="${ECHELON_CFG_RE_CHUNKING_STRATEGY:-${REVENGE_CFG_CHUNKING_STRATEGY:-${SPECKIT_REVERSE_ENG_CHUNKING_STRATEGY:-directory}}}"
...
if [[ "$CHUNKING_MODE" == "suggest" ]] && [[ "$needs_chunking" == "true" ]]; then
    ...
    echo "Set ECHELON_CFG_RE_CHUNKING_MODE=auto (or REVENGE_CFG_CHUNKING_MODE=auto) to enable" >&2
fi
