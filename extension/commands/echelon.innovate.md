...
- If the file does not exist, report **"No active squad run. Run b3c.echelon.run first."** and stop.
...
them into the current approach via a re-run of b3c.echelon.run.
============================================
```
