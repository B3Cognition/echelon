...
If `$ARGUMENTS` is empty or missing, report **"Please provide a question to investigate. Usage: b3c.echelon.investigate <your question>"** and stop.
...
> **After the subagent returns, proceed immediately to Step 5. Do not end your response here.**
