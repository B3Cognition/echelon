...
If `$ARGUMENTS` is empty or missing, report **"Please provide a question to investigate. Usage: /speckit.cognitive-squad.investigate <your question>"** and stop.
